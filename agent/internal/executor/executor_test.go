...
// collect pattern 白名单(审查 #3 回归测试):含空格、分号、反引号、$ 等 shell
// 元字符的 pattern 必须被 collectPatternOK 正则跳过,合法 pattern 照常收集。
func TestCollectSkipsDisallowedPattern(t *testing.T) {
