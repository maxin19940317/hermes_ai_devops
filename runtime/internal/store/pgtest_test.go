...
func openTestPG(t *testing.T) *PGStore {
	...
	if _, err := s.DB.ExecContext(ctx,
		`TRUNCATE artifacts, workflow_runs, clients, devices, device_leases, tasks, task_events, results, decisions, outbox, evidence_snapshots, command_translations, card_action_inbox, card_actions, card_action_messages, card_action_snapshots, audit_log CASCADE`); err != nil {
