...
# 12 个构建变体(pipeline 1113 起)。2026-08-06 包名变更:SNPE/TFLite 变体名
# 编码目标 SoC(Android/Linux 均 Qualcomm 平台,Linux TFLite 为 Qualcomm 编码);
...
EXPECTED_VARIANTS = {
    ...
    "aarch64_Linux_Qualcomm_TFLite_2.21.0",
}
